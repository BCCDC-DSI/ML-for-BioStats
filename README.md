...
| Analysis task | Complexity level | Date of last successful run | Notes | 
| :-- | :-- | :-- | :-- | 
...
| Graph neural networks | Advanced | | [Python scripts](https://github.com/dmlc/dgl/tree/master/examples/pytorch/ogc) <br> Requires ```Python 3.11.5 PyTorch 2.0.1 DGL 1.1.2 scikit-learn 1.3.1``` |
